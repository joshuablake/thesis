...
The duration distribution I will be concerned with is the distribution of the duration of positivity.
...
The approximation works especially well if used to make infernce based on noisy observations of the system, when the observation noise dominates is much larger than the infection process noise; I make a formalisation of this argument to justify a mean-field approximation of the prevalence process in \cref{E-inc-prev:sec:observation-process}.
