...
\todo[inline]{
    ...
    Would include \textcites{mccabeCISincidence}{abbottCISincidence} on backcalculation. Also Toffe?
...
For this, I first draw 500 samples from the approximate posterior distribution estimated.
