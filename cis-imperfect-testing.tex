...
\begin{figure}
  ...
  \caption[Simulation study results with varying test sensitivity]{%
    ...
    All simulations use a constant test sensitivity of 0.8 and the combination prior (as in \cref{imperf-test:fig:misspecified-test-sensitivity}), but the model assumes different values.
