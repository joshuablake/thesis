...
\begin{figure}
    ...
    \captionof{figure}[Posterior predictive prevalence (younger ages)]{%
        ...
        The error bar is the 95\% CrI including the noise due to the sampling (\ie observation process), aggregated by week.
...
\begin{figure}
    ...
    \captionof{figure}[Posterior predictive prevalence (older ages)]{%
        Posterior predictive prevalence for the older three age groups (see \cref{SEIR:fig:prev-young} for the others and details of the plot).
    }
