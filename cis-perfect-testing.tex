...
Then, in \cref{perf-test:sec:posterior}, I build a framework, using the concept of \textcite{heiseyModelling}.
I classify episode based on the possible patterns of the doubly interval censored pattern of the observations; and an \emph{undetected} region, which lead to the episode being undetected.
