...
\begin{figure}
  ...
  \todo[inline]{Label 0.6 sub-plot as (A) and 0.8 as (B). Include psens in the facet labelling.}
...
\begin{figure}
  ...
  \caption[Simulation study results with misspecified test sensitivity]{%
   ...
   \todo[inline]{Label sub-plots (A--C). Include psens in the facet labelling.}
