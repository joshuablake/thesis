...
cis-imperfect-testing.pdf: cis-imperfect-testing.tex main.tex references.bib
	$(LATEX_CMD)

cis-perfect-testing.pdf: cis-perfect-testing.tex main.tex references.bib cis-perfect-testing/regions_diag.png
	$(LATEX_CMD)
