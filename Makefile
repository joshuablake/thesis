...
IMPERF_DEPS = cis-imperfect-testing.tex cis-imperfect-testing/test-sens-bound.png cis-imperfect-testing/sim-single-positive-episodes.png cis-imperfect-testing/sim-constant-sensitivity.png cis-imperfect-testing/sim-misspecified-sensitivity.png cis-imperfect-testing/sim-variable-sensitivity.png cis-imperfect-testing/CIS_perfect.png cis-imperfect-testing/CIS_final.png cis-imperfect-testing/CIS_vary.png cis-imperfect-testing/CIS_ntot.pdf
...
TRANSMISSION_DEPS = transmission.tex SEIR/sim/data.png SEIR/sim/predictive_coverage.png SEIR/sim/coverage.pdf SEIR/sim/true_vs_posterior.png SEIR/CIS/prev_young.png SEIR/CIS/prev_old.png SEIR/CIS/incidence.png SEIR/CIS/p_peak.png SEIR/CIS/beta_walk.pdf SEIR/CIS/attack_rates.png
...
cis-imperfect-testing/CIS_perfect.png cis-imperfect-testing/CIS_final.png cis-imperfect-testing/CIS_vary.png: cis-imperfect-testing/CIS_survival.R utils.R cis-imperfect-testing/STATS17701/draws.rds ATACCC-distributions/posterior_samples.rds
	Rscript $<
