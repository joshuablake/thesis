...
\todo[inline]{Discuss noise in Ct values (batch effects, swabbing process, etc.) see commented-out text below}
...
\todo[inline]{%
    From chapter 7 add info on: how this is aggregated/stratified/etc, SRS computational limitations, definitions for each episode (sketched below).
}
