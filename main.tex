\documentclass[a4paper,12pt,custombib,times]{PhDThesisPSnPDF} % add print option for printing
\usepackage{graphicx}
...
\author{Joshua Blake}
\supervisor{Prof.~D.~De Angelis \newline Dr.~P.~Birrell}
\date{\today}
\dept{MRC Biostatistics Unit}
\university{University of Cambridge}
\crest{\includegraphics[width=0.45\textwidth]{University_Crest_Long}}
\college{Jesus College}
\collegeshield{\includegraphics[width=0.2\textwidth]{jesus}}
...
\begin{acknowledgements}      
    \todo[inline]{Acknowledgements here}    
