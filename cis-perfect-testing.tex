...
A related problem is estimating how long insect and bird nests survive for
In this context detected events are doubly interval censored and some events are undetected; Bayesian methods have been developed which augment the data with the unobserved times of infection~\autocite{heBayesiana,heBayesian,caoModeling}.
