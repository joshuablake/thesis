...
In this chapter, I use the estimate of the distribution of the duration of RT-PCR positivity from the combination of information from the ATACCC and CIS studies (see \cref{E-imperf-test:sec:conclusion}) to investigate the feasibility of estimating incidence and transmission of SARS-CoV-2 from only the CIS data (described in \cref{E-intro:sec:cis}).
...
I start with the backcalculation (\cref{backcalc}), based on \cref{E-inc-prev:eq:EPt}, which enables estimation of incidence within (sub)populations of England.
...
However, computational challenges make makes mean I favour the prevalence-inferred approach.

It will be convenient to define a variable equating to the quantity initially estimated.
Let $\pi_{i,t} = Z_{i,t}$ under the inference-inferred approach and $\pi_{i,t} = P_{i,t}$ under the prevalence-inferred approach.
