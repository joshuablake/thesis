...
All regions' MCMC chains converged, assessed using the Rhat statistic and ESS.
Rhat for all parameters is < 1.02, and for all parameters except $\sigma_\epsilon$ (a nuisance parameter), less than 1.01.
All parameters had ESS > 500, except $\sigma_\epsilon$ in the East Midlands, which had ESS of 334.
