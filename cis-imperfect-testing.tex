...
\todo{possibly a bit unclear phrasing here? struggling with it}
...
Second, I expanded the simulation study of \cref{E-perf-test:sec:simulation-study} to include false negatives (see \cref{imperf-test:sec:simulate} for more details).
...
Since the new mechanism is mutually exclusive with the previous one, $p_{iu}' = p_{iu} + \eta$.
...
In this chapter, I developed and applied novel methodology to estimate the duration distribution of PCR-positivity using information from two studies: ATACCC and CIS.
