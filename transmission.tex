...
Comparing the regional incidence estimates between the two models in this chapter.

Example of bias---variance trade-off.

Demonstrated by fitting to the North East.
Quality of fit in SEIR model is variable between different age groups.
