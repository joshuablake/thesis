...
\todo[inline]{double check correct terms for the below, especially rates vs instantaneous proportion and per unit time vs per day}
...
To relax the assumption of a well-mixed population, the population can be stratified by some characteristic.
