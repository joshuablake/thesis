...
\begin{itemize}
    \item $n_{taes}$ and $y_{taes}$ are the number of individuals tested and the number of positive test results on day $t$ in individuals of age group $a$, ethnicity $e$, and sex $s$. I use a beta-binomial distribution for the likelihood, as discussed in \cref{biology-data:sec:clustering}.
...
Therefore, computational approaches requiring high-performance computing, graphical processing units, or long runtimes are not feasible within the SRS.
