...
HIV is transmitted sexually or through blood.
It causes the disease AIDS.
AIDS has killed around 40 million people, peaking at 2 million annual deaths~\autocite{unaids2023}.
...
\todo{explain how AIDS diagnosis is "prevalence" data (is it?)}
...
The simplest plausible model is a time-inhomogenous Poisson process.
...
A common cause of overdispersion is super-spreading events.
\todo{ref}
A super-spreading event is an event where many more people than expected are infected.
Coronaviruses, such as SARS-CoV-2, have particularly high overdispersion.
\todo{insert a SARS-CoV-2 superspreading example}
...
Estimates for SARS-CoV-2 indicate $k \approx 0.1$, and can be increased by interventions such as lockdowns.
...
\todo[inline]{Explain backcalculation in HIV/AIDS context, and how it relates to what is above.}
...
\todo[inline]{Need some conclusion text for this section}
...
\todo[inline]{Comment on previous estimates of duration for SARS-CoV-2, but not sure where exactly this goes...}
