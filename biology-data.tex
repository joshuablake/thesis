...
The incubation period is undefined for asymptomatic individuals, around\todo{cite proportion asymptomatic} of those infected.
...
\todo[inline]{%
  Rewrite this section on imperfect testing.
  Including analytical sensitivity: the minimum number of copies of the target RNA material in the sample that the test can detect, measured using the 
}
