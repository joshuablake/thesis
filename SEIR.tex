...
\todo[inline]{Add an intro with an overview of what this chapter contains. Include why I discuss mechanistic models, how I will use them, and what they add to the previous analyses.}
...
Unlike the models previously encountered in this thesis, there will be dependence between $\vec{x}(t)$ and $\vec{x}(t')$.
...
Further discussion of stochastic models is beyond the scope of this thesis; \textcite[chapter 6]{keelingModeling} provides an introduction to these models.
...
Assume this individual makes contact with any other individual in the population at a constant rate, $\kappa$, in units of contacts per day.
...
For a randomly selected individual, the probability that they are susceptible is $s(t)$.
