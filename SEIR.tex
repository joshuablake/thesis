...
This allow changes in transmission to be decomposed into the components of the model, \eg the number of contacts per day or the probability of transmission upon contact.
...
\begin{figure}
    ...
    \caption{Posterior estimates of the attack rate in each region and age group.}
    \todo[inline]{Add and write about attack rates}
\end{figure}
