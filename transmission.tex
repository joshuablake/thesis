...
\begin{algorithm}
    \For{$j = 1, \dots, 500$}{
      ...
      \For{each stratum $i$}{
        \For{$t = -\dmax, \dots, 0$}{
            Set $Z^{(j)}_{i,t} = P^{(j)}_{i,1} / \sum_{k=1}^{\dmax} S(k)$ \;
        }
        \For{$t = 1, \dots, T$}{
...
\Cref{transmission:eq:forward-substitute} is derived from \cref{inc-prev:eq:EPt-matrix}: $\vec{P} = \matr{S} \vec{Z}$.
...
\begin{figure}
    ...
    \makebox[\textwidth][c]{\includegraphics{transmission/backcalc-regions}}
...
\end{figure}
\begin{figure}
    \makebox[\textwidth][c]{\includegraphics{transmission/backcalc-alpha}}
...
\begin{figure}
    \makebox[\textwidth][c]{\includegraphics{transmission/backcalc-ages}}
...
\begin{figure}
    \makebox[\textwidth][c]{\includegraphics{transmission/backcalc-start-effect}}
...
A novel approach (\cref{SEIR:sec:observation}) links this transmission model to the CIS prevalence data; the approach is generalisable to other gold-standard prevalence studies, \eg REACT.
...
\begin{figure}
    \thisfloatpagestyle{empty}
    \makebox[\textwidth][c]{\includegraphics{SEIR/sim/data}}
...
\begin{figure}
    \makebox[\textwidth][c]{\includegraphics{SEIR/sim/coverage}}
...
\begin{figure}
    \thisfloatpagestyle{empty}
    \makebox[\textwidth][c]{\includegraphics{SEIR/sim/predictive_coverage}}
...
\begin{figure}
    \thisfloatpagestyle{empty}
    \makebox[\textwidth][c]{\includegraphics{SEIR/CIS/incidence}}
...
\end{figure}
\begin{figure}
    \makebox[\textwidth][c]{\includegraphics{SEIR/CIS/p_peak}}
...
\begin{figure}
    \thisfloatpagestyle{empty}
    \makebox[\textwidth][c]{\includegraphics{SEIR/CIS/beta_walk}}
...
\begin{figure}
    \thisfloatpagestyle{empty}
    % \vspace{-3cm}
    \makebox[\textwidth][c]{\includegraphics{SEIR/CIS/prev_main}}
...
\begin{figure}
    \makebox[\textwidth][c]{\includegraphics{transmission/compare-regions}}
...
\begin{figure}
    \makebox[\textwidth][c]{\includegraphics{transmission/compare-NE}}
