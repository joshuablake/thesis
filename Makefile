...
IMPERF_DEPS = cis-imperfect-testing.tex cis-imperfect-testing/test-sens-bound.png cis-imperfect-testing/sim-single-positive-episodes.png cis-imperfect-testing/sim-constant-sensitivity.png cis-imperfect-testing/sim-misspecified-sensitivity.png cis-imperfect-testing/sim-variable-sensitivity.png cis-imperfect-testing/CIS_perfect.png cis-imperfect-testing/CIS_final.png cis-imperfect-testing/CIS_vary.png
