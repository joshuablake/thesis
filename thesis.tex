...
\makeatother
\usepackage[backend=biber,uniquename=false,sortcites=true,maxcitenames=2,style=apa]{biblatex}
...
% Note that the relationship between positivity (\ie the result of a RT-PCR test) and infectiousness (\ie an individual's ability to pass on the virus) is complex~\autocites{lascolaViral}{singanayagamDuration}, and beyond the scope of this thesis.
