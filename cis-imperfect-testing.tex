...
Introducing false negatives means that $O(j)$, containing the test results which would bound the length of episode $j$ in the absence of false negatives, is a random variable even after conditioning on $B_j$ and $E_j$.
