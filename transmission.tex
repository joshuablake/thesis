...
\todo[inline]{%
    Intro probably needs rewriting, with novelty claims and a bit more context.
    Revisit once intro chapters written.
    Question: is CIS (or similar) enough to estimate incidence / transmission?
...
\todo{what are the advantages of each approach specifically in this context?}
...
\todo[inline]{Rewrite this intro paragraph}
