...
\subsubsection{Positivity} \label{biology-data:sec:positivity}
...
\todo[inline]{Add ethnicity and other strata used in ch 7}

\subsubsection{Adjustment for non-response and data sparsity}
...
The outputs of this model compared to the unadjusted positivity rate are shown in \cref{biology-data:fig:CIS-positivity}.
