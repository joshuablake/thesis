...
Our prior belief is not well-represented by this prior, and in fact a priori viewed as extremely unlikely (see \cref{perf-test:fig:flat-prior}),
...
\begin{enumerate}
  ...
  \item Inclusion of covariates: age, previous exposure status, variant. \Cref
