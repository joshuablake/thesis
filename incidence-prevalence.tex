...
Ignoring the latent period will again underestimate the reproduction number~\autocite{wearingAppropriate}.
...
Formally, $P_{t_z,t_p}$ is the number of infection episodes with $B_i = t_z$ and $E_i \geq t_p$.
