...
I extend the methodology used to estimate prevalence from the CIS data, corrected for non-response bias, to estimate incidence\todo{cite Koen's stuff}.
...
Finally, I poststratify the posterior distributions of incidence to the CIS target population and subpopulations of interest.
...
Second, at low values of incidence or prevalence, linear growth is approximately exponential which is what mechanistic models predict, and has been shown to improve estimates of prevalence\todo{cite REACT paper on this, and check the exact meaning of "improve"}.
...
The matrix $\matr{S}$ is defined from the survival function to preserve the relationship between incidence and prevalence.
