...
\todo[inline]{%
  Chapter 3 needs a better title: this is not all the statistical and epidemiological background and some of it is mathematical modelling / disease dynamics.
  Perhaps: ``Data generating procsses and disease dynamics''.
  Would need to define disease dynamics.
}
