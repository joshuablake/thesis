...
However, initial application of this framework produced implausibly short estimates; I identified the issue as being due to the presence of false negatives, a form of misclassification bias, within the CIS (\cref{imperf-test:sec:issue}).
...
\section{The issues of false negatives} \label{imperf-test:sec:issue}
...
\section{Simulation study} \label{imperf-test:sec:sim-study}
