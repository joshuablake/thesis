...
BIOLOGY_DATA_DEPS = biology-data.tex biology-data/natural-history.png biology-data/CIS-positivity.pdf biology-data/CIS-num-tests.pdf biology-data/CIS-recruitment.pdf biology-data/STATS13734/data_viz.png
...
transmission-appendix.pdf: transmission-appendix.tex $(SHARED_DEPS)
	$(LATEX_CMD)
