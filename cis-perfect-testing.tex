...
\todo[inline]{make sure following paragraph makes sense in context (copy/pasted here)}
...
This is because the interval between tests in the same individual (up to 28 days, see\todo{ref section on the survey design}) is longer than most infections (median 16 days, see \cref{E-ATACCC:sec:results}).
\begin{figure}
...
\todo{using double interval censored before its defined}
