...
\todo[inline]{Add figure showing the approximation is good}
...
The assumption of constant incidence can lead to biased estimates\todo{cite}.
...
Next, we will see that this model is inadequate when false negatives are present, such as they are within the CIS data.
