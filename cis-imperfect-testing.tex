...
First, it is well known that PCR testing can return false negatives \todo{refs for sensitivity} and I needed to explicitly include these in the viral load model of \cref{ATACCC}; they can be directly observed within CIS sa intermittent negatives (see below).
...
\todo[inline]{Reference to ATCCCC chapter, although maybe the specific section with this result would be better}
...
\todo[inline]{Equation for linearly decreasing test sensitivity}
