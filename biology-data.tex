...
Larger time periods (\ie weeks instead of days) allow more granular estimates on other variables, most notably geographic area.
...
The MRP estimate tends to increase the estimated positivity rate, compared to uncorrected positivity rate, because underrepresented groups tend to have higher positivity.
...
Interpreting positivity, or prevalence, directly is difficult because it is a delayed and smoothed measure of incidence (see \cref{inc-prev:sec:prevalence-process}).
...
A sample of 500 randomly selected infection episodes (selected from the episodes used in the analyses in this thesis) have their test results.
