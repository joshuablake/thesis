...
An alternative approach would be to estimate incidence proportion directly from the RT-PCR test results.
...
The strata will represent at least age group and region, although including ethnicity and sex is also included due to non-response in the survey (see \cref{E-intro:sec:cis-strata}).
