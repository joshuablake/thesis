...
BIOLOGY_DATA_DEPS = biology-data.tex biology-data/natural-history.png biology-data/CIS-positivity.pdf biology-data/CIS-num-tests.pdf biology-data/CIS-recruitment.pdf
