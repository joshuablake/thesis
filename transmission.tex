...
\begin{figure}
    \todo[inline]{Four-panel regions figure}
    \capton[Incidence estimated using backcalculation by region]{%
...
\begin{figure}
    \todo[inline]{age groups figure}
    \capton[Incidence estimated using backcalculation by age group]{%
...
\begin{figure}
    \todo[inline]{start effect figure}
    \capton[Edge effects in backcalculation method]{%
        First seven days of incidence proportion estimate for the whole of England, highlighting the edge effect.
    }
    \label{transmission:fig:start-effect}
\end{figure}
...
\todo[inline]{What happened to the following paragraph? It doesn't make sense currently!}
...
The posteriors align very closely with the priors (not shown\todo{consider showing prior/posterior plots}) which reinforces this finding.
...
When the peak in incidence is estimated to occur varied by region, but due to the switching, is almost always on a Sunday (see \cref{SEIR:fig:peak-incidence}).
