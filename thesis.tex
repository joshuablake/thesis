...
\abstract{%
    ...
    I extend a pre-existing model of how an individual's viral load changes over time to estimate the duration of detectability.
...
\preface{%
    ...
    In particular, an earlier version of the phenomenological backcalculation was adopted by the Office for National Statistics to estimate incidence, published in their weekly online reports~\autocite{cisMethodsONS}.
