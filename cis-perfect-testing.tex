...
These studies (and some others~\autocite{shenNonparametric}) take a conditional likelihood approach, conditioning on both the truncation (a selection effect) and the period where the infection is censored to\todo{clumsy sentence}.
They condition on the time of infection is because this information was considered to provide little information on the incubation period~\citePersonalComms{Nick Jewell}.
