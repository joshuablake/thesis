...
\todo[inline]{
    ...
    In particular: \textcites{mccabeCISincidence}{abbottCISincidence}. Also Toffe.
...
\todo[inline]{make sure to proofread this section due to merge conflicts}
...
Therefore, I extend the methodology previously previously used to estimate prevalence from the CIS data, corrected for non-response bias, to estimate incidence\todo{cite Koen's stuff}.
...
I follow this same process, except I transform the posterior distribution of prevalence in each stratum to a posterior distribution of incidence before post-stratifying.
...
\todo[inline]{Describe the model precisely, see eg RTM paper 2}
...
The matrix $\matr{S}$needs to bebased on preserves the relationship between incidence and prevalence.
