...
\acknowledgements{%
    ...
    Dr Koen Pouwels provided code used as the basis of the positivity model in \cref{biology-data:sec:MRP}.
    Dr Edwin van Leeuwen created the contact matrices and Dr Sanmitra Ghosh provided code for the MCMC sampler used in \cref{E-SEIR}.
...
\preface{%
    In October 2019 I began a PhD project entitled ``Advancing Bayesian Statistical Methods for Real-Time Epidemic Monitoring''.
    So began a journey of reading, and an expectation of few deadlines, a lot of deep thinking, and complex statistical theory.
    Like much of the world, the events of early 2020 changed that.
    Following a brief interlude to provide rapid support to the response, the origins of this thesis emerged.

    Several aspects of my work were done to support the ongoing response.
    In particular, an earlier version of the backcalculation work was adopted by the Office for National Statistics to estimate incidence, published in their weekly online reports.
