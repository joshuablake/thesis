...
\end{align}
using the mean-dispersion parametrisation of the beta-binomial distribution.
$\rho$ is a nuisance parameter controlling the dispersion of the beta-binomial distribution.
