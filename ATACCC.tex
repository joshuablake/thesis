...
Individual 55 has an extremely noisy set of observations, fit well by two different viral load trajectories (shown in \cref{ATACCC:fig:individual-55}).
...
The population-level parameter estimates agree between the two sets of chains, therefore the issue should not affect any estiamtes of interest.
\begin{figure}
...
\todo[inline]{Probably important to show estimated test sensitivity here to refer to later}
