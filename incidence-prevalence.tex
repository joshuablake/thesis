...
\todo{add discussion of proportions vs rates}
...
Here, an individual is defined to have SARS-CoV-2 on day $t$ if, had they been swabbed on day $t$, that swab would return a positive RT-PCR test.
...
The simplest compartmental model for a disease which confers immunity is the (SIR) model\todo{cite SIR being simplest} (depicted in \cref{SEIR:fig:SIR}).
The name SIR derives from the structure of the model.
