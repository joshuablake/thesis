...
This is because the interval between tests in the same individual (up to 28 days, see\todo{ref section on the survey design}) is longer than most infections (median around 15 days, see\todo{ref ATACCC chapter}).
\begin{figure}
...
\todo{Make sure "detectable" is defined: It's really a latent quantity, which could possibly be defined in terms of true viral load. I think "positive probability of testing positive" under the assumption of no false positives is what I will go with, or by reference to a multi-state model type view of infection.}
\begin{align}
