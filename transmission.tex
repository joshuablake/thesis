...
\todo[inline]{This is now mostly in chapter 2, double-check there's nothing missed
...
The statistical model used for inference, including the borrowing of information, should have the following properties.
\begin{itemize}
...
The most explored explanation for this is the emergence of the Alpha variant, which was more transmissible than previous variants and emerged at different times across the country~\autocites{walkerTracking}{daviesEstimated}{lythgoeLineage}.
...
I link the modelled proportion of individuals that are PCR positive to the data using a beta-binomial likelihood (as discussed in \cref{transmission:sec:data}).
