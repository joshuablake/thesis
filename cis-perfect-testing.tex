...
Therefore, estiamtes of the mean are sensitive to the tail of the duration distribution.
...
This is because interval between tests in the same individual (up to 28 days, see\todo{ref section on the survey design}) is longer than most infections (median around 15 days, see\todo{ref ATACCC chapter}).
\begin{figure}
