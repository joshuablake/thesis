...
\begin{itemize}
    ...
    \item The basic reproduction number for this model is $\R = \beta / \gamma$~\autocite[20]{keelingModeling}.
...
\todo{Update with fitting issues if they reoccur on final runs}
...
To check that the inference was working correctly, I calculated the coverage of the 50\%, 75\%, and 95\% central credible intervals for each parameter and simulation.
...
Overall, coverage was\todo{comment on sim study coverage}
\begin{figure}
    \includegraphics{SEIR/sim/coverage}
    \caption[Coverage of simulation study]{%
        Coverage of the 50\%, 75\%, and 95\% central credible intervals for each parameter.
        The lines shows the nominal coverage.
    }
