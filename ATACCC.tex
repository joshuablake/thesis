...
\todo[inline]{Needs intro paragraph, remember to mention using ATACCC data and ref section}
...
To improve sampling efficiency, the multivariate version of the non-centred parameterisation\todo{REF NCP} is used.
...
\begin{figure}
  \todo[inline]{Create figure with individual 55's trajectories}
