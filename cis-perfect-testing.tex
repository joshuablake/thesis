...
This issue can be rectified by considering the inadmissible region as many subregions, which leads to the same result (sketched in \cref{perf-test:sec:alt-likelihood}).
