...
\todo[inline]{Check for "REF" in this appendix}
...
\begin{table}[]
    ...
    \end{tabular}}
    \caption{Summary of results in comparison to previous studies. \Textcite{jonesEstimating} do not give values in terms of Ct.}
